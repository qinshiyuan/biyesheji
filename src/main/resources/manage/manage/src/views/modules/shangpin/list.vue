                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <!--<el-button v-if="isAuth('shangpin','修改')" type="primary" icon="el-icon-add-location" size="mini" @click="plusShangpinKucunNumber(scope.row.id,scope.row.shangpinKucunNumber)">增加卡券商品库存</el-button>-->
                            <!--<el-button v-if="isAuth('shangpin','修改')" type="primary" icon="el-icon-delete-location" size="mini" @click="reduceShangpinKucunNumber(scope.row.id,scope.row.shangpinKucunNumber)">减少卡券商品库存</el-button>-->
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
			...
			//数据不为空放值
				...
				//标题
				this.shangpinKucunNumberTitle = '增加卡券商品库存'
			},
			//减少卡券商品库存
			...
			//数据不为空放值
				...
				this.shangpinKucunNumberVisible = true;
				//标题
				this.shangpinKucunNumberTitle = '减少卡券商品库存'
			},
			//提交用户操作卡券商品库存数量
			addShangpinKucunNumber(){
				...
				if(this.kucunNumberTypes == "+"){
					...
					if(this.shangpinKucunNumber < this.kucunNumber || this.kucunNumber <= 0){
						this.$message.error('卡券商品库存不足不能减少');
						return false;
					}else{
						maxNumber = this.shangpinKucunNumber - this.kucunNumber
					}
