    ...
    >
      <el-row>
        ...
        <el-col :span="12" v-if="sessionTable != 'shangpin'">
          ...
          >
            <el-input
              v-model="shangpinForm.shangjiaName"
              placeholder="商家名称"
              clearable
              readonly
            ></el-input>
  ...
  methods: {
    ...
    onSubmit() {
      this.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          this.$http({
            url: `shangjiaReport/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm,
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangjiaReportCrossAddOrUpdateFlag = false;
                  this.parent.search();
