	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback"
		...
		<view class="bottom-content cu-bar bg-white tabbar border shop">
			<view style="width: 100%;margin: 0 auto;display: flex;align-items: center;justify-content: space-around;">
				...
				<view>
					<view @tap="reportback(detail.id)" class="round cu-btn lines-grey mid margin-right-sm">举报</view>
				</view>
			      ...
			      <view class="uni-flex uni-column"
			        ...
			        <view class="flex-item flex-item-V">
			          ...
			          <textarea
			            ...
			            v-model="shangjiaReportReason" placeholder="举报内容"></textarea>
			        </view>
		...
		methods: {
			// 打开举报弹窗
			   ...
			   async onFinishReportTap() {
			     ...
			     // 调用接口提交举报
			     await _this.$api.requestCondition("shangjia", 'submitReport', data);
			...
			async init() {
				...
				this.detail.shangjiaContent = this.detail.shangjiaContent.replace("<img", "<img  class=\"daxiao\"")
