        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.shangpinName" type="text" v-model="ruleForm.shangpinName" placeholder="卡券商品名称"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">卡券商品编号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.shangpinUuidNumber" type="text" v-model="ruleForm.shangpinUuidNumber" placeholder="卡券商品编号"></input>
            </view>
                <view
                ...
                <view
                        ...
                        class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">卡券商品库存</view>
                    <input   disabled
                             :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                             :disabled="ro.shangpinKucunNumber" type="number" v-model="ruleForm.shangpinKucunNumber" placeholder="卡券商品库存"></input>
                </view>
                <view
                        :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                        class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">卡券商品热度</view>
                    <input   disabled
                             :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                             :disabled="ro.shangpinClicknum" type="number" v-model="ruleForm.shangpinClicknum" placeholder="卡券商品热度"></input>
                </view>
<!-- text后缀 -->
            <view
                ...
                <textarea :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.shangpinContent" v-model="ruleForm.shangpinContent" placeholder="卡券商品介绍"/>
            </view>
        ...
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.shangpinName)) {
                    this.$utils.msg(`卡券商品名称不能为空`);
                    return
                }
				if ((!this.ruleForm.shangpinUuidNumber)) {
                    this.$utils.msg(`卡券商品编号不能为空`);
                    return
                }
				if ((!this.ruleForm.shangpinPhoto)) {
                    this.$utils.msg(`卡券商品照片不能为空`);
                    return
                }
				if ((!this.ruleForm.shangpinKucunNumber) && (!this.$validate.isIntNumer(this.ruleForm.shangpinKucunNumber)) && this.ruleForm.shangpinKucunNumber >0) {
                    this.$utils.msg(`卡券商品库存不能为空，不能小于0 格式为数字`);
                    return
                }
				if ((!this.ruleForm.shangpinClicknum) && (!this.$validate.isIntNumer(this.ruleForm.shangpinClicknum)) && this.ruleForm.shangpinClicknum >0) {
                    this.$utils.msg(`卡券商品热度不能为空，不能小于0 格式为数字`);
                    return
                }
                if (this.ruleForm.id) {
