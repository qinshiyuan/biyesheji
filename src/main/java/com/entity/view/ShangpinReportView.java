...
public class ShangpinReportView extends ShangpinReportEntity implements Serializable {
	...
	//级联表 卡券商品
		...
		*/
		...
		@ColumnInfo(comment="卡券商品名称",type="varchar(200)")
		private String shangpinName;
		/**
		* 卡券商品编号
		*/

		@ColumnInfo(comment="卡券商品编号",type="varchar(200)")
		private String shangpinUuidNumber;
		/**
		* 卡券商品照片
		*/

		@ColumnInfo(comment="卡券商品照片",type="varchar(200)")
		private String shangpinPhoto;
		/**
		* 卡券商品类型
		*/
		@ColumnInfo(comment="卡券商品类型",type="int(11)")
		private Integer shangpinTypes;
			/**
			* 卡券商品类型的值
			*/
			@ColumnInfo(comment="卡券商品类型的字典表值",type="varchar(200)")
			private String shangpinValue;
		/**
		* 卡券商品库存
		*/

		@ColumnInfo(comment="卡券商品库存",type="int(11)")
		private Integer shangpinKucunNumber;
		/**
		* 卡券商品原价
		*/
		@ColumnInfo(comment="卡券商品原价",type="decimal(10,2)")
		...
		*/
		...
		@ColumnInfo(comment="卡券商品热度",type="int(11)")
		private Integer shangpinClicknum;
		/**
		* 卡券商品介绍
		*/

		@ColumnInfo(comment="卡券商品介绍",type="longtext")
	...
	public ShangpinReportView() {

	}

	public ShangpinReportView(ShangpinReportEntity shangpinReportEntity) {
		try {
			BeanUtils.copyProperties(this, shangpinReportEntity);
