...
public class ShangpinOrderController {
    ...
    @Autowired
    private ShangpinReportService shangpinReportService;//卡券商品评价
...
//                            shangpinOrderEntity.setShangpinId(Integer.valueOf(data.get(0)));   //卡券商品 要改的
    ...
    */
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : shangpins) {
           //取值
            Integer shangpinId = Integer.valueOf(String.valueOf(map.get("shangpinId")));//卡券商品id
            Integer buyNumber = Integer.valueOf(String.valueOf(map.get("buyNumber")));//购买数量
            ShangpinEntity shangpinEntity = shangpinService.selectById(shangpinId);//购买的卡券商品
            ...
            shangpinOrderEntity.setShangpinId(shangpinId);//卡券商品
    ...
    */
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        String role = String.valueOf(request.getSession().getAttribute("role"));
            ...
            shangpinService.updateById(shangpinEntity);//更新订单中卡券商品的信息
    ...
    */
    ...
    public R submitReport(Integer id, String reportReason, HttpServletRequest request){
       ShangpinOrderEntity shangpinOrder = shangpinOrderService.selectById(id);
        ...
        shangpinReportEntity.setId(id);
        shangpinReportEntity.setShangpinId(shangpinId);
        shangpinReportEntity.setYonghuId((Integer) request.getSession().getAttribute("userId"));
        shangpinReportEntity.setReportReason(reportReason);
        shangpinReportEntity.setInsertTime(new Date());
        shangpinReportEntity.setCreateTime(new Date());
        shangpinReportService.insert(shangpinReportEntity);

        shangpinOrder.setShangpinOrderTypes(106);//设置订单状态为已评价
        shangpinOrderService.updateById(shangpinOrder);//根据id更新
        return R.ok();
    }
