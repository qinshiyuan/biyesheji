...
public class CommonController {
    ...
    @RequestMapping(value = "/list/getData1")
    public R getData1() {
    ...
    @RequestMapping(value = "/list/getData2")
    public R getData2() {
    ...
    @RequestMapping(value = "/list/getData3")
    public R getData3() {
        List<Map<String, Object>> list = commonService.getData3();
        List key = new ArrayList();
        List val = new ArrayList();
        Map returnMap = new HashMap<String, List>();
        for (Map<String, Object> m : list) {
    ...
    @RequestMapping(value = "/list/getData4")
    public R getData4() {
        List<Map<String, Object>> list = commonService.getData4();
